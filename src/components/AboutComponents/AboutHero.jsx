  ...
  return (
    <div className="flex flex-col gap-4 bg-black">
      <div className="flex justify-between items-center w-[100%]">
        ...
        <p className="text-5xl uppercase   text-white">About Us</p>
      </div>

      <div className="flex font-josefin md:flex-row flex-col justify-between items-start bg-black py-12 px-4 ">
