  ...
  return (
    <div className="flex justify-between md:flex-row flex-col items-start bg-black py-12 px-4 ">
      ...
      <div className="md:w-[40%] w-[100%] md:pt-20 pt-8 flex flex-col gap-4 text-end px-4 text-[#FFFFFF]">
        ...
        <p>
          By associating with our prestigious award program, our sponsors align
          their brands with the values of unity, progress, and pride that
          resonate not only throughout Africa but across the globe.
        </p>
