  ...
  return (
    <div className="border-b-[#BF8134]  border-2 border-l-0 border-r-0 border-t-[#BF8134]">
      <div className="flex flex-col w-[100%] gap-8 bg-black p-8">
        <table class="table-auto uppercase text-center w-[100%] overflow-y-scroll bg-white">
          <thead>
        ...
        <div className="flex justify-center items-center gap-4">
          <div className="flex bg-white w-[60%] border-4 border-[#BF8134]  h-[103px] justify-center items-center gap-4">
            <img
              src="/download.png"
              alt=""
              className="h-[50px] w-[50px] object-contain"
            />
            <p className="text-3xl uppercase font-semibold text-[#BF8134] ">
